...
class MyFrame():
    def __init__(self, net, loss, lr, evalmode=False):
        ...
        #         nn.init.kaiming_uniform_(m.bias.data,  nonlinearity='relu')
        ...
        self.optimizer = torch.optim.Adam(params=self.net.parameters(), lr=lr)  # use it afterwards

        #self.optimizer = adabound.AdaBound(self.net.parameters(), lr = lr , final_lr=lr * 100)

        # self.optimizer = torch.optim.SGD(params=self.net.parameters(), lr = lr , momentum=0.9)
